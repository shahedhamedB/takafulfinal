...
class AppliedFormActivity : AppCompatActivity() {
    ...
    fun btnNotify() {
        ...
        val builder: NotificationCompat.Builder = NotificationCompat.Builder(this)
            ...
            .setContentTitle("تم ارسال طلبك ") //set title of notification
            .setContentText("تم تقديم طلب المعونة بنجاح بانتظار موافقة مسؤول التنمية") //this is notification message
